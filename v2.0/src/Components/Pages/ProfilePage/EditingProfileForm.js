...
class EditingProfileForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      color: props.user.user_info && props.user.user_info.prefs && props.user.user_info.prefs.color ? props.user.user_info.prefs.color : "#135dfe",
    ...
    return (
      <form onSubmit={this.onSubmit}>
        ...
        >
          ...
          ></img> :
          <img src={createImagefromInitials(this.state.color, this.state.full_name, 50)}
          ></img>}
          <input
            type="file"
